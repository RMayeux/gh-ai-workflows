import{a as e,c as t,d as n,l as r,n as i,o as a,r as o,s,t as c,u as l}from"../schemas-T5pK6j4e.mjs";import{t as u}from"../markdown-N2G_IbEu.mjs";import{Logger as d,PromptEngine as f,ProviderRegistry as p,generateStructured as m}from"@core";const h=e({summary:a().min(1,`Summary is required`),issues:i(e({severity:c([`error`,`warning`,`info`]),description:a()})).default([]),approved:o().default(!1)}),g={id:`pr-review`,system:`You are a staff-level engineer performing a code review on a pull request.
