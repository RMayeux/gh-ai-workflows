import{a as e,c as t,d as n,l as r,n as i,o as a,r as o,s,t as c}from"../schemas-T5pK6j4e.mjs";import{Logger as l,PromptEngine as u,ProviderRegistry as d,generateStructured as f}from"@core";const p=e({title:a().min(1,`Title is required`).max(72,`Title must be under 72 characters`),body:a().min(1,`Body is required`),change_type:c([`feat`,`fix`,`refactor`,`perf`,`docs`,`test`,`build`,`ci`,`chore`]),breaking:o().default(!1),doc_impact:o().default(!1),doc_slugs:i(a()).default([])}),m={id:`pr-metadata`,system:`You are a staff-level engineer analyzing a pull request.
