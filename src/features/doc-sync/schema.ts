...
export const DocSyncSchema = z.object({
  ...
  changes: z.array(z.object({
    ...
    content: z.string().describe('The full new content of the file (empty if action is delete)'),
...
export const DocSyncInputsSchema = z.object({
  ...
  lookbackCommits: z.number().int().positive().default(10).describe('Number of commits to look back if no audit PR is found'),
